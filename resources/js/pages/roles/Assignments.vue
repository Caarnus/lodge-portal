...
<template>
    ...
    <main class="mx-auto w-full max-w-6xl p-4 sm:p-6 lg:p-8">
        ...
        <div
            class="mt-4 divide-y divide-border/80 rounded-lg border border-border/80 bg-card"
        >
            <div
                v-for="user in users.data"
                :key="user.id"
                class="grid gap-3 p-4 transition-colors hover:bg-muted/35 md:grid-cols-[minmax(12rem,1fr)_minmax(16rem,1.5fr)_minmax(14rem,1fr)] md:items-center"
            >
                <div>
