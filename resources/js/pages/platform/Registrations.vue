...
const decide = (id: number, decision: 'approved' | 'rejected') => {
    ...
    router.patch(
        ...
        {
            decision,
            reason: decision === 'rejected' ? 'Rejected by administrator' : null,
        },
        {
            preserveScroll: true,
        ...
        <div class="mt-6 overflow-hidden rounded-lg border border-slate-200">
            ...
            >
                <div class="min-w-0 space-y-1">
                    <ExpandableText :text="registration.name" label="registrant name" class="font-semibold" />
                    <ExpandableText :text="registration.email" label="email address" class="text-sm text-slate-600" />
                    <ExpandableText
                ...
                <div class="flex shrink-0 gap-2">
                    <button
                        ...
                        v-tooltip.top="{ value: `Approve ${registration.name}`, showDelay: 2000 }"
                    ...
                    <button
                        ...
                        v-tooltip.top="{ value: `Reject ${registration.name}`, showDelay: 2000 }"
            ...
            <p v-if="registrations.length === 0" class="p-8 text-center text-sm text-slate-500">
