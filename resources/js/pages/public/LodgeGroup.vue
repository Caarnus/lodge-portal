...
<template>
    ...
    <main class="min-h-dvh bg-background px-5 py-8 text-foreground sm:py-12">
        <div class="mx-auto max-w-5xl">
            ...
            <section>
                <h2 class="text-xl font-semibold">Member lodges</h2>
                <div
                    v-if="lodges.length"
                ...
                <p
                    v-else
                    class="mt-4 rounded-lg border border-dashed border-border/80 bg-card p-5 text-muted-foreground"
                >
                    No active lodges currently belong to this group.
                </p>
            </section>
            <section class="mt-10">
                <h2 class="text-xl font-semibold">Upcoming public events</h2>
                <div v-if="events.length" class="mt-4 grid gap-3">
                    <a
                        ...
                        <p v-if="event.location_name" class="mt-1 text-sm">
                            {{ event.location_name }}
                        </p></a
                    >
                </div>
