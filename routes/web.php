...
use App\Http\Controllers\LodgeModuleController;
...
use App\Http\Controllers\Platform\LodgeModuleController as PlatformLodgeModuleController;
...
Route::middleware(['auth', 'verified', 'approved', 'admin-2fa'])->group(function () {
    ...
    Route::get('platform/lodges/{lodge}/modules', [PlatformLodgeModuleController::class, 'edit'])->name('platform.lodges.modules.edit')->middleware('platform-admin');
    Route::put('platform/lodges/{lodge}/modules/{feature}', [PlatformLodgeModuleController::class, 'update'])->name('platform.lodges.modules.update')->middleware('platform-admin');
    ...
    Route::get('lodges/{lodge}/modules', [LodgeModuleController::class, 'index'])->name('lodges.modules.index');
    Route::put('lodges/{lodge}/modules/{feature}', [LodgeModuleController::class, 'update'])->name('lodges.modules.update');
